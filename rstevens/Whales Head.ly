...
r1 r1 r2. Fa,4 | La La La so | so8[ fa] La[ So] Fa4 | 
...
r1 r2. Fa4 la8 [so] la[ mi] Fa4 so Fa la Fa 
Fa4 | so so so La | so Fa Fa Fa la2 so so1
...
Fa2 Fa4 mi | Fa2. so4 Fa Fa Fa La | So La Fa Fa4
so2 so Fa1
}
