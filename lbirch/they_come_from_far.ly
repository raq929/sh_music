...
r4. Fa8 | La4 So | Fa La | Fa4. So8 | Fa4.
...
so8 | so4 fa8 [La] fa4 Fa | so'4. so8 | so4.
Fa,8 | so'4 Fa | so8 (La4) so8 | Fa,2
r4. Fa8 | Fa4 so'4 Fa8 [mi] la4 | Fa4. So8 | Fa4.
Fa,8 | so'4 fa4 | so so Fa mi Fa4.
Fa,8 | Fa8 [So] La [fa] so8 (La4) so8 <Fa Fa,>2
}
