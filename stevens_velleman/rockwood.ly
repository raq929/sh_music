...
\repeat volta 2 { r4 | r1 | r2. so,4 | Fa So4 Fa So | La2. fa4 | so2. (La4 | fa4 La2) La4 | so Fa, So So | La2. }
}
...
bassMusic = \fasola Fa {
 ...
 \repeat volta 2 { so4 | Fa Fa So8[ Fa] So4 | La Fa la so | La4 So Fa So | La2. so4 | Fa2.( mi4 | la2.) so4 | Fa La, So so | Fa2. }
}
