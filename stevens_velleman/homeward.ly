...
\repeat volta 2 {
r2. La | La4 Fa Fa So2. | La2 so4 la so La | Fa2. So2 La4 | La so so so La so | La2. 
}
La so4 so La <Fa' so>2. so2 la4 so La Fa La2. 
...
\repeat volta 2 {
r2. Fa2. La4 so la | so2. La2 So4 | Fa So La la2., so2 | la4 Fa Fa Fa So La So | Fa2.
}
La2. So4 Fa la so2. | so2 la4 Fa4 La so | la2. la2. | so4 La So Fa So La | So2. 
